    ...
    return <Controller
      ...
      render={({ field: { ref: innerRef, ...field }, ...other }) => {
        const propsMapped = Object.keys(field).reduce((acc, keyFrom) => {
          ...
          acc[keyTo ?? keyFrom] = keyTo?.match(/^on/g) ? composeEventHandlers(propFrom, props[keyTo], { checkDefaultPrevented: false }) : propFrom;
          return acc;
        }, {});
...
//# sourceMappingURL=withController.mjs.map

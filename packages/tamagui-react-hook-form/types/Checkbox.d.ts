...
export declare const CheckboxControlled: import("react").ForwardRefExoticComponent<Omit<import("./types").WithControllerProps<Partial<import("tamagui").CheckboxProps & import("react").RefAttributes<HTMLButtonElement>>, import("react-hook-form").FieldValues>, "ref"> & import("react").RefAttributes<unknown>> & {

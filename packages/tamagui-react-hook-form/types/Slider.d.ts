...
export declare const SliderControlled: import("react").ForwardRefExoticComponent<Omit<import("./types").WithControllerProps<Partial<import("tamagui").SliderProps & import("react").RefAttributes<import("react-native/types").View>>, import("react-hook-form").FieldValues>, "ref"> & import("react").RefAttributes<unknown>> & {

...
export declare const InputControlled: import("react").ForwardRefExoticComponent<Omit<import("./types").WithControllerProps<Partial<import("react-native/types").TextInputProps & Omit<import("tamagui").TextProps, keyof import("react-native/types").TextInputProps> & Omit<{}, "size" | "unstyled"> & {
